...
exports.generatePostmanCollection = void 0;
 ...
 */
const readFilesRecursively = (dir, targetDirs, fileContents = {}) => {
 ...
 */
const sendToOpenAI = async (prompt, openaiApiKey) => {
 ...
 */
const generatePostmanCollection = async ({ sourceDirectories, openaiApiKey, outputFilePath }) => {
